...
& $Compiler "$template/src/main.zan" "$template/src/Tables.zan" "$template/src/Data.zan" "$template/src/Game.zan" "$template/src/Save.zan" --auto-stdlib -o "$Output/Legend.exe"
